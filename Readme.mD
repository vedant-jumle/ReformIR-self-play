...
For instance if you want to reproduce qa expand at c=50 on dl22 sunstitute the corresponding run file names that can be found under runs/ in names=[] array and set mode to "reuse". 

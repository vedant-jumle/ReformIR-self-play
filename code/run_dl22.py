...
class RemoveColon(pt.Transformer):
    def transform(self, topics):
        ...
        return topics
qrels = pd.read_csv(f"data/dl22.dedup.qrels", header=None, sep=" ", names=["qid", "Q0", "docno", "label"],
...
result = pt.Experiment(
    ...
    names=[
     ...
     #f"BM25_query2doc_monot5.c{args.budget}",
     #f"BM25_query2doc_reformopt_monot5.c{args.budget}",
     #f"BM25_RM3_monot5.c{args.budget}",
       # f"BM25_qa_expand_monot5_v2.c{args.budget}", # this is final
       # f"BM25_qa_expand_rrf_monot5.c{args.budget}", # final
       # f"BM25_qa_expand_Reformopt_monot5_final_v2.c{args.budget}", # this si final 
       # f"BM25_genr_ensemble_prf_monot5.c{args.budget}",
       # f"BM25_genr_ensemble_prf_reformopt_monot5.c{args.budget}",
      #  f"BM25_genqr_final_monot5.c{args.budget}",
      #  f"BM25_genqr_test_v2_monot5.c{args.budget}",

       # f"BM25_genqr_ensemble_rrf_monot5.c{args.budget}", final
